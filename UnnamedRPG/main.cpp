        ...
        if (player.health <= 0) {
            ...
            if (action == "fight" || action == "f") {
                ...
                if (it == player.inv_to_potion.end()) {
                    ...
                    if (player.Inventory[potion_chosen] == 0) {
                        player.Inventory.erase(potion_chosen);
                    }
                }
            }
            else {
...
int rpg(Char &player, const location& location) {
    cout << "Type 'help' or 'h' for help at any time, 'exit' or 'e' to quit the game, 'fight' or 'f' to "
    ...
    while (true) {
        ...
        if (input == "exit" || input == "e") {
            ...
            cout << "Commands to use: help (h), character info (c), fight (f), dungeon, inventory (i), locations (l) "
                    "or exit (e). " << endl;
        }
